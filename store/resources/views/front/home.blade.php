                        ...
                        <div class="slider-head">
                            ...
                            <div class="hero-slider">
                                ...
                                <div class="single-slider"
                                    style="background-image: url(https://dummyimage.com/800x500);">
                                    <div class="content">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-6 col-12 md-custom-padding">
                                ...
                                <div class="hero-small-banner"
                                    style="background-image: url('https://dummyimage.com/370x250');">
                                    <div class="content">
                                        <h2>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-category">
                            ...
                            <div class="images">
                                <img src="https://dummyimage.com/180x180" alt="#">
                            </div>
                        </div>
                        <!-- End Single Category -->
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="single-banner" style="background-image:url('https://dummyimage.com/620x340')">
                            <div class="content">
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="single-banner custom-responsive-margin"
                            style="background-image:url('https://dummyimage.com/620x340')">
                            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-12 col-12">
                            ...
                            <div class="col-lg-4 col-md-4 col-12">
                                ...
                                <div class="single-product">
                                    <div class="product-image">
                                        <img src="https://dummyimage.com/335x335" alt="#">
                                        <div class="button">
                        ...
                        <div class="single-banner right"
                            style="background-image:url('https://dummyimage.com/730x310');margin-top: 30px;">
                            <div class="content">
                    ...
                    <div class="col-lg-4 col-md-12 col-12">
                        <div class="offer-content">
                            <div class="image">
                                <img src="https://dummyimage.com/510x600" alt="#">
                    ...
                    <div class="col-lg-4 col-md-4 col-12 custom-responsive-margin">
                        ...
                        <div class="single-list">
                            <div class="list-image">
                                <a href="product-grids.html"><img src="https://dummyimage.com/100x100" alt="#"></a>
                            </div>
                            <div class="list-info">
                                <h3>
                ...
                <div class="brands-logo-wrapper">
                    <div class="brands-logo-carousel d-flex align-items-center justify-content-between">
                        <div class="brand-logo">
                            <img src="https://dummyimage.com/220x160" alt="#">
                        </div>
                        <div class="brand-logo">
                            <img src="https://dummyimage.com/220x160" alt="#">
                        </div>
                        ...
                        <div class="single-blog">
                            <div class="blog-img">
                                <a href="blog-single-sidebar.html">
                                    <img src="https://dummyimage.com/370x215" alt="#">
                                </a>
                            </div>
